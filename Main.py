...
def create_game(sprite_size, is_new):
    ...
    if is_new:
        ...
        # with ScreenEngine.GameSurface as SE: # that line makes mistake
        drawer = SE.GameSurface((640, 480), pygame.SRCALPHA, (0, 480), SE.ProgressBar((640, 120), (640, 0),
        SE.InfoWindow((160, 600), (50, 50),
        SE.HelpWindow((700, 500), pygame.SRCALPHA, (0, 0), SE.ScreenHandle((0, 0))
        ) # HelpWindow ending parenthesis
        ) # InfoWindow ending parenthesis
        ) # ProgressBar ending parenthesis
        ) # GameSurface ending parenthesis
